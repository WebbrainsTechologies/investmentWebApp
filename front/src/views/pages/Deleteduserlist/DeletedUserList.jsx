...
import ChangeuserStatus from "../userList/ChangeuserStatus";
...
const DeletedUserList = props => {
      ...
      },
      {
        ...
        Cell: tableInstance => (
          <span>
            ...
            >
              {!tableInstance.row.original?.is_delete ? "Active" : "Inactive"}
            </div>
          </span>
        )
      },
            ...
            <div className="react-action-class">
              <button
                ...
                onClick={() => {
                  ...
                  // setOpenModal(true);
                  history.push(
                    `/userdetail/${tableInstance.row.original?._id}?userDetails=deleted`
                  );
                }}
              >
  ...
  const getUserHandler = useCallback(async () => {
    ...
    await delteduserlist(token, data)
      .then(res => {
