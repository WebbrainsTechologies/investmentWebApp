...
const AdminTransactionList = props => {
  ...
  const columns = useMemo(
    () => [
      ...
      },
      {
        ...
        Cell: tableInstance => (
          <span>{tableInstance.row.original.userId?.name}</span>
        )
      },
      {
        Header: tableInstance => {
      ...
      // },
      {
        ...
        Cell: tableInstance => (
          <span>{tableInstance.row.values?.transaction_type}</span>
        )
      },
      {
        Header: tableInstance => {
  ...
  const getServiceHandler = useCallback(async () => {
    ...
    setloader(true);
    await getAdminTransectionList(token, data)
      .then(res => {
