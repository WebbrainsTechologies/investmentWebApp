...
const UserWithdrawalRequestView = props => {
  const {
    token,
    onClose,
    viewData,
  ...
  useEffect(() => {
    if (viewData) {
      setValues({ ...values, userId: viewData.userId._id });
    }
  }, []);
  ...
  return (
    <>
      <div className="row px-2 py-4 mx-0">
        ...
        {viewData.withdrawal_status === "Closed" ? (
          <div className="col-12 mb-2">
            <div className="form-group">
              <label>Status</label>
              <input
                ...
                className="form-control react-form-input"
                id="status"
                value={viewData.withdrawal_status}
                placeholder={"status"}
                disabled
                readOnly
              />
          ...
          <div className="col-12 mb-2">
            ...
            <select
              name="status"
              id="status"
              defaultValue={viewData.withdrawal_status}
              disabled={true}
        ...
        {viewData.withdrawal_status === "Rejected" &&
        viewData?.withdrawal_remark ? (
          <div className="col-12">
            <div className="form-group">
              ...
              <textarea
                ...
                defaultValue={viewData.withdrawal_remark}
