export const AppName = "Secure Fintec";
...
export const image_small_size = "Maximum allowed file size is 5MB";
export const formate_image_upload_error =
  "This file format is not accepted. You can upload only JPEG,JPG and PNG";
